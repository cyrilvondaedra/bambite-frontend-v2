...
export default function JoinBamsTeamSection() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      ...
      <div className="relative mt-4 sm:mt-6 md:mt-8 lg:absolute lg:flex lg:h-[50.691px] lg:items-center lg:justify-center lg:left-[calc(6.25%+140.13px)] lg:top-[168px] lg:translate-x-[-50%] lg:w-[89.128px]">
